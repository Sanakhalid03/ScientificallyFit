...
const AnimatedButton = ({
  ...
  const base =
    "px-6 py-3 rounded-xl font-semibold shadow-lg transition-all transform flex items-center justify-center gap-2 text-white";
  const styles =
    variant === "primary"
...
export default function AssessmentPage() {
  ...
  // ✅ Corrected function with TypeScript type
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-indigo-50 via-white to-cyan-50 p-8">
          ...
          {!isComplete ? (
            ...
            >
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-3xl p-10 shadow-2xl"
                >
                  <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center shadow-lg">
                      <currentQuestion.categoryIcon className="w-5 h-5 text-white" />
                    </div>
                  ...
                  <div className="grid gap-4">
                    {currentQuestion.options.map((option, idx) => (
                      <motion.button
                        ...
                        className={`w-full p-4 rounded-xl border-2 text-left shadow-sm transition-all duration-200 ${
            ...
            >
              <motion.div
                ...
                className="w-24 h-24 rounded-full bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center mx-auto mb-8 shadow-lg"
              >
                <Check className="w-12 h-12 text-white" />
              </motion.div>

              <h2 className="text-4xl font-extrabold mb-4 text-gray-800">Assessment Complete</h2>
              ...
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-3xl p-10 shadow-2xl max-w-xl mx-auto text-left"
              >
